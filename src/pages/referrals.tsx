      ...
      <Layout>
        <section className="spotlight style1 orient-left content-align-left image-position-center">
          <div className="content">
            <h2>Referrals</h2>
            <p>
              For providers: please use this form to send a referral to
              Caladrius Therapy.
            </p>
            <form name="referrals" method="POST" data-netlify="true">
              ...
              <div className="fields">
                ...
                <div className="field half">
                  <label htmlFor="referral-address">
                  ...
                  <div className="checkboxes grid grid-cols-2 md:grid-cols-3 gap-2">
                    ...
                    <div className="checkbox">
                      <input
                        ...
                        id="assessment"
                        name="referral-reasons"
                        value="Comprehensive Clinical Assessment"
                      />
                    ...
                    <div className="checkbox">
                      <input
                        ...
                        name="referral-reasons"
                        value="Trauma Informed Comprehensive Clinical Assessment"
                      />
                      <label htmlFor="trauma-assessment">
                ...
                <div className="field">
                  <label htmlFor="referral-description">
                  ...
                  <textarea
                    ...
                    rows={4}
                    required
                    placeholder="PLEASE FORWARD MEDICAL & BEHAVIORAL INFORMATION, COURT REPORTS, SOCIAL SUMMARIES, PREVIOUS EVALUATIONS, ETC."
                  ></textarea>
                </div> */}
                <div className="field">
                ...
                <div className="field">
                  ...
                  <div className="checkboxes grid grid-cols-2 md:grid-cols-3 gap-2">
                    {/* 
                  <label>Your Role: <select name="insurance[]" multiple>
      ...
      <option value="aetna">AETNA</option>
                    ...
                    <div className="checkbox">
                      <input
                        ...
                        id="alliance"
                        name="insurance"
                        value="Alliance Medicaid"
                      />
                      <label htmlFor="alliance">
                        Alliance Medicaid (requires a single case agreement
                    ...
                    <div className="checkbox">
                      <input
                        ...
                        id="sliding-scale"
                        name="insurance"
                        value="Request for Sliding Scale"
                      />
                      <label htmlFor="sliding-scale">
