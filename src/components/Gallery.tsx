      ...
      <section className="wrapper style1 align-center">
        ...
        >
          <SwiperSlide style={{ width: "420px", height: "630px"}}>
            ...
            <article>
              <a href="/our-space/IMG_0399_square.jpg" className="image">
                <StaticImage
                  src="../../static/our-space/IMG_0399_square.jpg"
                  alt="Caladrius Therapy Office"
                  width={630}
                  height={630}
                />
        ...
        <SwiperSlide style={{ width: "630px", height: "630px" }}>
            <article>
              <a href="/our-space/IMG_0366_square.jpg" className="image">
                <StaticImage
                  src="../../static/our-space/IMG_0366_square.jpg"
                  alt="Caladrius Therapy Office"
                  width={630}
                  height={630}
                />
          ...
          <SwiperSlide style={{ width: "420px", height: "630px" }}>
            {" "}
            <article>
              <a href="/our-space/IMG_0377.jpg" className="image">
                <StaticImage
                  src="../../static/our-space/IMG_0377.jpg"
                  alt="Caladrius Therapy Office"
                  width={420}
                  height={630}
                />
          ...
          <SwiperSlide style={{ width: "630px", height: "630px"}}>
            <article>
              <a href="/our-space/IMG_5706_square.jpg" className="image">
                <StaticImage
                  src="../../static/our-space/IMG_5706_square.jpg"
                  alt="Caladrius Therapy Office"
                  width={630}
                  height={630}
                />
          ...
          <SwiperSlide style={{ width: "630px", height: "630px"}}>
            <article>
              <a href="/our-space/0J7A3085.jpg" className="image">
                <StaticImage
                  src="../../static/our-space/0J7A3085_square.jpg"
                  alt="Caladrius Therapy Office"
                  width={630}
                  height={630}
                />
